...
public class Credits implements Parcelable {
    ...
    */
    ...
    public Credits(JSONObject casts) throws JSONException {

        mCastId = casts.getInt("cast_id");
        mCharacter = casts.getString("character");
        mCreditId = casts.getString("credit_id");
        mId =casts.getInt("id");
        mName = casts.getString("name");
        mProfilePath = casts.getString("profile_path");
